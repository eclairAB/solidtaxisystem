	...
	<div id='body_div'>
		...
		<?php
		    		...
		    		$row = MYSQL_SELECT("select * from driver where d_id=".$_SESSION['cashier_driver_id'],$sess_name4,9);
					 ...
					 if($row != 0)
					 {
				    	...
				    	for($x=0;$x<$row;$x++)
				    	{
				    		...
				    		<td><a href='cashier.php?driverremove=".$_SESSION[$sess_name4.'_'.$x.'_0']."'><button type='button' id='_buttons' class='btn-danger'>Remove</button></a></td>
				    		</tr>";
				    	}
			...
			if(isset($_SESSION['cashier_driver_id']))
			{
				...
				<button type='button' class='btn-success' style='padding:20px 20px 20px 20px' onclick='window.location.href=\"cashier_billing.php\"'>Create Billing</button>
				
				<button type='button' class='btn-success' style='padding:20px 20px 20px 20px' onclick='window.location.href=\"cashier_payment.php\"'>Payment</button>

				<button type='button' class='btn-success' style='padding:20px 20px 20px 20px' onclick='window.location.href=\"cashier_gas.php\"'>Refill Gas</button>

				<button type='button' class='btn-success' style='padding:20px 20px 20px 20px' onclick='window.location.href=\"cashier_print_receipt.php\"'>Print Receipt</button>
