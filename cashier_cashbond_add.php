...
<title>Taxi System - Cashier - Cash Bond</title>
			...
			if(isset($_SESSION['cashier_driver_id']))
			{
				...
				echo "
						...
						echo "
							...
							<form action='functions/cashier_cashbond_add.php' method='post'>
							...
							<center><button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"cashier_cash bond.php\"'>Go Back</button></center>
