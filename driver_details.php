...
<body>
	...
	<div style='padding:10px'>
		...
		<?php
								...
								// $thisweek = strtotime('weekly');

							    $sess_name911 = "data911_" . Date('Y') . Date('m') . Date('d') . Date('H') . Date('i') . Date('s');


							    $query119 = "select taxi.body_no,taxi.plate_no,in_out.in_time,in_out.out_time  from taxi,in_out where in_out.d_id=".$_SESSION[$sess_name.'_0_0'] . " and YEARWEEK(out_time)=YEARWEEK(NOW(),1) and in_out.t_id=taxi.t_id order by in_out.io_id desc";
			...
			$sess_name4 = "data4_" . Date('Y') . Date('m') . Date('d') . Date('H') . Date('i') . Date('s');
		    		...
		    		$row = MYSQL_SELECT("select * from driver where d_id=".$_SESSION[$sess_name.'_0_0'],$sess_name4,9);
				    	...
				    	for($x=0;$x<$row;$x++)
				    	{
				    		...
				    		{
				    			echo "<td><img class='img-responsive img-rounded' src='img/profile_pic/".$_SESSION[$sess_name4.'_'.$x.'_8']."' height=\"100px\" width=\"100px\"/></td>";
				    		}
				    		else
				    		{
				    			echo "<td>No Image</td>";
					  ...
					  //filter data on search
						...
						<div class='row'>
							...
							<div class='col-sm-6'>
								...
								<form action='driver_details.php' method ='get'>
									...
									<center><input type='submit' value='Filter Data' style='padding:20px 40px 20px 40px' class='btn-primary' /></center>
						...
						<center><button type='button' class='btn-primary' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"driver.php\"'>Go Back</button></center>
						...
						echo "
							...
							<div style='height:600px;overflow-x:scroll'>";
								    	...
								    	<div class='row'>
											...
											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total Gas Pumped: <b style='color:#c65825'>".number_format($total_gas_pump,2)." Liters</b></h2></center>
												</div>
											</div>
										...
										<div style='height:600px;overflow-x:scroll;'>
											...
											<center><h1><b>Grouped SSS</b></h1></center>
											<br>
											<br>
											...
											<center><h1><b>SSS Remitance History</b></h1></center>
											<br>
											<br>
									...
									<div class='row'>
											...
											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total SSS Contribution: <b style='color:#c65825'>".number_format($sss_group_total,2)."</b></h2></center>
												</div>
											</div>

											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total SSS Remitance: <b style='color:#c65825'>".number_format($sss_total_remitance,2)."</b></h2></center>
												</div>
											</div>
									...
									<hr>
									<br>
										<center><h1><b>PAG-IBIG</b></h1></center>
										<br>
										<br>
										...
										<div style='height:600px;overflow-x:scroll'>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    $PAGIBIG_group = array(array(),array(),array());
													    $PAGIBIG_group_index = 0;

													    $PAGIBIG_group_total = 0;

													    $total_contribution_count_pagibig = $PAGIBIG_index;

													    for($x=0;$x<$PAGIBIG_index;$x++)
													    {

													    	$notinside = true;

													    	for($y=0;$y<$PAGIBIG_group_index;$y++)
													    	{
													    		if($PAGIBIG[$x][0]==$PAGIBIG_group[$y][0])
													    		{
													    			$PAGIBIG_group[$y][1] += $PAGIBIG[$x][1];
													    			$notinside = false; 
													    		}
													    	}
													    	...
													    	if($notinside==true)
													    	{
													    		$PAGIBIG_group[$PAGIBIG_group_index][0] = $PAGIBIG[$x][0];
													    		$PAGIBIG_group[$PAGIBIG_group_index][1] = $PAGIBIG[$x][1];
													    		$PAGIBIG_group_index++;
													    	}
													    	...
													    	<tr>
													      	<td>".$PAGIBIG[$x][0]."</td>
													        <td>".number_format($PAGIBIG[$x][1],2)."</td>
													        <td>".DateNumToTextAndTime($PAGIBIG[$x][2])."</td>
													      	</tr>
											...
											<center><h1><b>Grouped PAG-IBIG</b></h1></center>
											<br>
											<br>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    for($x=0;$x<$PAGIBIG_group_index;$x++)
													    {
													    	echo "

													    		<tr>
														      	<td>".$PAGIBIG_group[$x][0]."</td>
														        <td>".number_format($PAGIBIG_group[$x][1],2)."</td>
														        </tr>
													    		";

													    	$PAGIBIG_group_total += $PAGIBIG_group[$x][1];
													    }
											...
											<center><h1><b>PAG-IBIG Remitance History</b></h1></center>
											<br>
											<br>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    $sess_name10555 = "data10555_" . Date('Y') . Date('m') . Date('d') . Date('H') . Date('i') . Date('s')."PAGIBIG";
								    					$row5555PAGIBIG = MYSQL_SELECT("select * from driver_remitance where d_id = ". $_SESSION[$sess_name.'_0_0'] . " and remitance_type='PAGIBIG' order by d_rem_id desc",$sess_name10555,4);


								    					$total_remitance_count_pagibig = $row5555PAGIBIG;


								    					$PAGIBIG_total_remitance = 0;

								    					for($x=0;$x<$row5555PAGIBIG;$x++)
								    					{
								    						$PAGIBIG_total_remitance += $_SESSION[$sess_name10555.'_'.$x.'_2'];
								    						echo "
								    						<tr>
								    							<td>".number_format($_SESSION[$sess_name10555.'_'.$x.'_2'],2)."</td>
								    							<td>".DateNumToTextAndTime($_SESSION[$sess_name10555.'_'.$x.'_3'],2)."</td>
									...
									<div class='row'>
											...
											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total PAG-IBIG Contribution: <b style='color:#c65825'>".number_format($PAGIBIG_group_total,2)."</b></h2></center>
												</div>
											</div>

											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total PAG-IBIG Remitance: <b style='color:#c65825'>".number_format($PAGIBIG_total_remitance,2)."</b></h2></center>
												</div>
											</div>

											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>PAG-IBIG Available: <b style='color:#c65825'>".number_format($PAGIBIG_group_total-$PAGIBIG_total_remitance,2)."</b></h2></center>
												</div>
											</div>
									...
									<hr>
									<br>
										<center><h1><b>PhilHealth</b></h1></center>
										<br>
										<br>
										...
										<div style='height:600px;overflow-x:scroll'>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    $PHILHEALTH_group = array(array(),array(),array());
													    $PHILHEALTH_group_index = 0;

													    $PHILHEALTH_group_total = 0;

													    $total_contribution_count_philhealth = $PHILHEALTH_index;

													    for($x=0;$x<$PHILHEALTH_index;$x++)
													    {

													    	$notinside = true;

													    	for($y=0;$y<$PHILHEALTH_group_index;$y++)
													    	{
													    		if($PHILHEALTH[$x][0]==$PHILHEALTH_group[$y][0])
													    		{
													    			$PHILHEALTH_group[$y][1] += $PHILHEALTH[$x][1];
													    			$notinside = false; 
													    		}
													    	}
													    	...
													    	if($notinside==true)
													    	{
													    		$PHILHEALTH_group[$PHILHEALTH_group_index][0] = $PHILHEALTH[$x][0];
													    		$PHILHEALTH_group[$PHILHEALTH_group_index][1] = $PHILHEALTH[$x][1];
													    		$PHILHEALTH_group_index++;
													    	}
													    	...
													    	<tr>
													      	<td>".$PHILHEALTH[$x][0]."</td>
													        <td>".number_format($PHILHEALTH[$x][1],2)."</td>
													        <td>".DateNumToTextAndTime($PHILHEALTH[$x][2])."</td>
													      	</tr>
											...
											<center><h1><b>Grouped PhilHealth</b></h1></center>
											<br>
											<br>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    for($x=0;$x<$PHILHEALTH_group_index;$x++)
													    {
													    	echo "

													    		<tr>
														      	<td>".$PHILHEALTH_group[$x][0]."</td>
														        <td>".number_format($PHILHEALTH_group[$x][1],2)."</td>
														        </tr>
													    		";

													    	$PHILHEALTH_group_total += $PHILHEALTH_group[$x][1];
													    }
											...
											<center><h1><b>PhilHealth Remitance History</b></h1></center>
											<br>
											<br>
											...
											<table class='table table-striped' style='border:2px solid #5e78a3'>
												<thead style='color:white;background-color:#5e78a3' >
													    ...
													    $sess_name10555 = "data10555_" . Date('Y') . Date('m') . Date('d') . Date('H') . Date('i') . Date('s')."PHILHEALTH";
								    					$row5555PHILHEALTH = MYSQL_SELECT("select * from driver_remitance where d_id = ". $_SESSION[$sess_name.'_0_0'] . " and remitance_type='PHILHEALTH' order by d_rem_id desc",$sess_name10555,4);

								    					$total_remitance_count_philhealth = $row5555PHILHEALTH;

								    					$PHILHEALTH_total_remitance = 0;

								    					for($x=0;$x<$row5555PHILHEALTH;$x++)
								    					{
								    						$PHILHEALTH_total_remitance += $_SESSION[$sess_name10555.'_'.$x.'_2'];
								    						echo "
								    						<tr>
								    							<td>".number_format($_SESSION[$sess_name10555.'_'.$x.'_2'],2)."</td>
								    							<td>".DateNumToTextAndTime($_SESSION[$sess_name10555.'_'.$x.'_3'],2)."</td>
										...
										<div class='row'>
											...
											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total PhilHealth Contribution: <b style='color:#c65825'>".number_format($PHILHEALTH_group_total,2)."</b></h2></center>
												</div>
											</div>

											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>Total PhilHealth Remitance: <b style='color:#c65825'>".number_format($PHILHEALTH_total_remitance,2)."</b></h2></center>
												</div>
											</div>

											<div class='col-sm-4'>
												<div style='padding:20px;border:2px solid black;background-color:lightgray'>
												<center><h2 style='color:black'>PhilHealth Available: <b style='color:#c65825'>".number_format($PHILHEALTH_group_total-$PHILHEALTH_total_remitance,2)."</b></h2></center>
												</div>
											</div>
									...
									<br>
										...
										<br>
										<h4>Total SSS Contribution Count: ".$total_contribution_count_sss ."</h4>
										<h4>Total SSS Remitance Count: ".$total_remitance_count_sss ."</h4>

										<br>
										<h4>Total PAG-IBIG Contribution Count: ".$total_contribution_count_pagibig ."</h4>
										<h4>Total PAG-IBIG Remitance Count: ".$total_remitance_count_pagibig ."</h4>

										<br>
										<h4>Total PhilHealth Contribution Count: ".$total_contribution_count_philhealth ."</h4>
										<h4>Total PhilHealth Remitance Count: ".$total_remitance_count_philhealth ."</h4>
