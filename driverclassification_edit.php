<?php
		...
		if(isset($_GET['id']))
		{
			if(preg_match("/^[0-9]{1,}$/", $_GET['id']))
			{
				...
				MYSQL_SELECT("select * from driver_class where dc_id=".$_GET['id'],$sess_name,1);
...
<title>Taxi System - Admin - Driver Classification - Edit</title>
...
<body>
	...
	<div class='container'>
		...
		<h4><b>Edit Driver Classification</b></h4>
		...
		<form action='functions/driverclassification_edit.php' method='post'>
					...
					<div class='form-group'>
						...
						<input type='text' name='driver_classification_tb' class='form-control' value='<?php echo $_SESSION[$sess_name.'_0_1']; ?>' requried/>
					</div>

			

					<div class='form-group'>
						<input type='submit' class='form-control' value='Update Driver Classification'/>
					</div>
