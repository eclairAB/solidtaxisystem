...
if($_POST)
{
	...
	if(isset($_POST['address_tb']) && isset($_POST['contact_no_tb']) && isset($_POST['first_name_tb'])&& isset($_POST['middle_name_tb'])&& isset($_POST['last_name_tb']) && isset($_POST['gender_cb']) && isset($_POST['birthdate_tb'])  && isset($_POST['id_tb']))
	{
		...
		if($ok == true)
		{
			...
			if($ok_photo==true)
			{
				...
				MYSQL_UPDATE("update driver set f_name='".$_POST['first_name_tb']."',m_name='".$_POST['middle_name_tb']."',l_name='".$_POST['last_name_tb']."',gender='".$_POST['gender_cb']."',birthdate='".$_POST['birthdate_tb']."',address='".$_POST['address_tb']."',contact_no='".$_POST['contact_no_tb']."',profile_pic='".$photo_name."',dc_id=".$_SESSION[$sess_name.'_0_0']." where d_id=".$_POST['id_tb']);


			}
			else
			{
				MYSQL_UPDATE("update driver set f_name='".$_POST['first_name_tb']."',m_name='".$_POST['middle_name_tb']."',l_name='".$_POST['last_name_tb']."',gender='".$_POST['gender_cb']."',birthdate='".$_POST['birthdate_tb']."',address='".$_POST['address_tb']."',contact_no='".$_POST['contact_no_tb']."',dc_id=".$_SESSION[$sess_name.'_0_0']." where d_id=".$_POST['id_tb']);
			}
			

			include("logs.php");
			log_add("Updated a driver. Driver Name: ".$_POST['first_name_tb']." ".$_POST['middle_name_tb']." ".$_POST['last_name_tb'] . " / ID: ". $_POST['id_tb']);
