...
function getDailyReport($date, $taxiClassification)
{
    ...
    $finalData = array(
        ...
        "currentGasPrice" => number_format(getCurrentGasPrice()),
...
function getTotalRentalAmount($billingId)
{
    ...
    $query = "select coalesce(sum(t_current_rent_price),0) as totalRentalAmount from billing_taxi where b_id=" . $billingId . " group by b_id";
