	...
	<div id='body_div'>
		...
		<?php
			...
			if(isset($_SESSION['gas_taxi_id']) && isset($_SESSION['gas_driver_id']))
			{
				...
				<form action='gas_add.php' method='post'>
					<div class='form-group'>
		 ...
		 if($row != 0)
		 {
		 	echo "
		    	...
		    	for($x=0;$x<$row;$x++)
		    	{
		    		...
		    		<td><a href='gas.php?driverid=".$_SESSION[$sess_name.'_'.$x.'_0']."'><button type='button' id='_buttons' class='btn-success'>Select Driver</button></a></td>
		    		</tr>";
		    	}
		 	...
		 	//search taxi
		    	...
		    	for($x=0;$x<$row2;$x++)
		    	{
								...
								if($ok == true)
								{
						    		...
						    		<td><a href='gas.php?taxiid=".$_SESSION[$sess_name6.'_'.$x.'_0']."'><button type='button' id='_buttons' class='btn-success'>Select Taxi</button></a></td>
						    		</tr>";
					    		}
		    	}
