...
<title>Taxi System - Guard - In</title>
...
<body>
	...
	<div id='body_div'>
		...
		<?php
			...
			echo "<center><h1>Taxi Return</h1></center>";
		...
		<?php
			...
			if(isset($_SESSION['guard_taxi_id']) && isset($_SESSION['guard_driver_id']))
			{
				...
				<center><button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"guard_in_add.php\"'>Confirm</button></center>

				<br>

				<center><button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"guard.php\"'>Go Back</button></center>
