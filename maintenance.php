...
<title>Taxi System - Admin - Maintenance</title>
...
<body>
	...
	<div class='container'>
		...
		<h4><b>Add New Maintenance Job</b></h4>
		<button style='color:black!important' onclick='window.location.href="maintenance_add.php"'>Add New</button>
		<br>
		<br>

		<h4><b>List of Maintenance Jobs</b></h4>
		...
		<table class='table table-striped table-bordered'>
		    ...
		    <tbody>
		    	...
		    	$row = MYSQL_SELECT("select * from taxi_maintenance_jobs",$sess_name,1);
		    	...
		    	for($x=0;$x<$row;$x++)
		    	{
		    		...
		    		<td><a href='maintenance_edit.php?id=".$_SESSION[$sess_name.'_'.$x.'_0']."'>Edit</a></td>
		    		</tr>";
		    	}
