...
<title>Taxi System - Admin - Maintenance - Add</title>
...
<body>
	...
	<div class='container'>
		...
		<form action='functions/maintenance_add.php' method='post'>
					<div class='form-group'>
						<label>Maintenance Job</label>
						<input type='text' name='maintenance_job_tb' class='form-control' requried/>
					</div>

					<div class='form-group'>
						<input type='submit' class='form-control' value='Add Maintenance Job'/>
					</div>
