				...
				echo "
							...
							<table class='table table-striped' style='border:2px solid #5e78a3'>
								<thead style='color:white;background-color:#5e78a3' >
								    	...
								    	$row100 = MYSQL_SELECT("select remit,d_rem_date,remarks from driver_remitance where d_id = ". $_SESSION['cashier_driver_id'] . " and remitance_type='cash bond' order by d_rem_id desc",$sess_name100,2);
								    	...
								    	for($x=0;$x<$row100;$x++)
								    	{
									    		...
									    		echo "
									    		 				<tr>
																  ...
																  <td>".$_SESSION[$sess_name100.'_'.$x.'_2']."</td>
						...
						echo "
							...
							<form action='remit_cashbond_add.php' method='post'>

							<div class='form-group'>
								<label id='search_label'>Remitance Amount</label>
								<input id='search_label' type='number' step='any' name='remitance_amount' id='search_box' class='form-control' required/>
								<label class='big-text'>Remarks</label>
								<input type='text' name='remitance_remarks' id='search_box' class='form-control' required/>
							</div>
							...
							<center><button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"remit.php\"'>Go Back</button></center>
