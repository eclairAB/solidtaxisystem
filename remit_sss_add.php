...
<title>Taxi System - Remittance - SSS</title>
			...
			if(isset($_SESSION['cashier_driver_id']))
			{
				...
				echo "
						...
						echo "
							...
							<form action='functions/remit_sss_add.php' method='post'>
							...
							<center><button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"remit_sss.php\"'>Go Back</button></center>
