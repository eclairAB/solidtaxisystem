			...
			if(isset($_SESSION['success']))
			{
				...
				unset($_SESSION['success']);
		    		...
		    		$row3 = MYSQL_SELECT("select * from taxi where t_id=".$_SESSION[$sess_name.'_0_0'],$sess_name9,4);
						...
						<button type='button' class='btn-success' style='padding:20px 40px 20px 40px' onclick='window.location.href=\"taxi_change_oil_add.php?id=".$_GET['id']."\"'>Change Oil Now</button>
						...
						";
					 	...
					 	<table class='table table-striped'>
					    		...
					    		$row900 = MYSQL_SELECT("select * from taxi_change_oil where t_id=".$_SESSION[$sess_name.'_0_0'] . " order by tco_id desc",$sess_name900,3);

					    		for($x=0;$x<$row900;$x++)
					    		{
					    			echo "<tr>
					    				<td>".number_format($_SESSION[$sess_name900.'_'.$x.'_2'])."</td>
					    				<td>".DateNumToTextAndTime($_SESSION[$sess_name900.'_'.$x.'_3'])."</td>
					    				</tr>";
