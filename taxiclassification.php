...
<title>Taxi System - Admin - Taxi Classification</title>
...
<body>
	...
	<div class='container'>
		...
		<button style='color:black!important' onclick='window.location.href="taxiclassification_add.php"'>Add New</button>
		<br>
		<br>

		<h4><b>List of Taxi Classification</b></h4>
		...
		<table class='table table-striped table-bordered'>
		    ...
		    <tbody>
		    	...
		    	$row = MYSQL_SELECT("select * from taxi_class",$sess_name,2);
		    	...
		    	for($x=0;$x<$row;$x++)
		    	{
		    		...
		    		<td><a href='taxiclassification_edit.php?id=".$_SESSION[$sess_name.'_'.$x.'_0']."'>Edit</a></td>
		    		</tr>";
		    	}
