...
<title>Taxi System - Admin - Taxi Classification - Add</title>
...
<body>
	...
	<div class='container'>
		...
		<h4><b>Add New Taxi Classification</b></h4>
		...
		<form action='functions/taxiclassification_add.php' method='post'>
					<div class='form-group'>
						<label>Taxi Classification</label>
						<input type='text' name='taxi_classification_tb' class='form-control' requried/>
					</div>

					<div class='form-group'>
						<label>Rental Price</label>
						<input type='number' step="any" name='rental_price_tb' class='form-control' requried/>
					</div>

					

					<div class='form-group'>
						<input type='submit' class='form-control' value='Add Taxi Classification'/>
					</div>
