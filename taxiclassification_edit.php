<?php
		...
		if(isset($_GET['id']))
		{
			if(preg_match("/^[0-9]{1,}$/", $_GET['id']))
			{
				...
				MYSQL_SELECT("select * from taxi_class where tc_id=".$_GET['id'],$sess_name,2);
...
<title>Taxi System - Admin - Taxi Classification - Edit</title>
...
<body>
	...
	<div class='container'>
		...
		<h4><b>Edit Taxi Classification</b></h4>
		...
		<form action='functions/taxiclassification_edit.php' method='post'>
					...
					<div class='form-group'>
						...
						<input type='text' name='taxi_classification_tb' class='form-control' value='<?php echo $_SESSION[$sess_name.'_0_1']; ?>' requried/>
					</div>

					<div class='form-group'>
						<label>Rental Price</label>
						<input type='number' step="any" name='rental_price_tb' class='form-control' value='<?php echo $_SESSION[$sess_name.'_0_2']; ?>'  requried/>
					</div>

			

					<div class='form-group'>
						<input type='submit' class='form-control' value='Update Taxi Classification'/>
					</div>
